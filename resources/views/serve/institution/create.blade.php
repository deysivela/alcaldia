...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2 style="font-size: 18px;">Crear Nuevo Usuario<small></small></h2>
      ...
      <div class="x_content">
        <br />
        <form class="form-horizontal form-label-left" method="POST" action="/user" enctype="multipart/form-data">
          @csrf
		<div class="col-md-6 col-sm-6 col-xs-12">
		  <div class="form-group">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <input type="text" id="name" name="nombre" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <input id="middle-name" class="form-control col-md-7 col-xs-12" type="email" name="correo">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-4 col-sm-4 col-xs-12">Contraseña</label>
            <div class="col-md-8 col-sm-8 col-xs-12">
              <input id="birthday" class="form-control col-md-7 col-xs-12" type="password" name="contra">
            </div>
          </div>
		  <div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
            	...
            	<div class="col-md-9 col-sm-9 col-xs-12">
              	<input type="file" id="profile-img" name="foto" required="required" class=" jo form-control col-md-7 col-xs-12">
            	</div>
          	</div>
          	<div class="form-group">
          		<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
          			<img src="" id="profile-img-tag" width="170px" style="border-radius: 2%;">	
          		</div>
          	</div>
		</div>
		  <div class="clearfix"></div>
